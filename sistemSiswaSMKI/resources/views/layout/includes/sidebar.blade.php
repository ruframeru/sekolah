  ...
  @if(auth()->user()->role == 'admin')
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Semua Data</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/Kelas">
              <i class="bi bi-door-open-fill"></i><span>Kelas</span>
            </a>
          </li>
          <li>
            <a href="/Guru">
              <i class="bi bi-person-lines-fill"></i><span>Data Guru</span>
            </a>
          </li>
          <li>
            <a href="/Mapel">
